...
package io.github.shymoy.termagent.history;
...
public class HistoryStore {
     ...
     * 默认构造函数 - 将历史记录存储在 {@code ~/.termagent/prompt_history.jsonl} 中。
    ...
    private static Path defaultHistoryPath() {
        try {
            return AppPaths.promoteUserFile("prompt_history.jsonl");
        } catch (IOException ignored) {
            return AppPaths.user("prompt_history.jsonl");
        }
    }
