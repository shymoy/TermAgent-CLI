...
import io.github.shymoy.termagent.tui.Styles;
...
public class PlanApprovalDialog {
    ...
    private static final String[] OPTIONS = {
            ...
            "Tell TermAgent-CLI what to change",
    };
    ...
    public String render() {
        ...
        sb.append(HEADER_STYLE.render(
                " TermAgent-CLI has written up a plan and is ready to execute. Would you like to proceed?"));
        sb.append("\n\n");
