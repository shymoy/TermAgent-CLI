...
package io.github.shymoy.termagent.prompt;

import io.github.shymoy.termagent.prompt.PromptBuilder.EnvironmentContext;
import io.github.shymoy.termagent.prompt.PromptBuilder.Section;
...
public final class PromptSections {
    ...
    static final String IDENTITY_CONTENT = """
            You are TermAgent-CLI, an AI programming assistant running in the terminal. You help users with \
